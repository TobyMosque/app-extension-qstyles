class MetaService {
  metas = {
    ...
    'QBreadcrumbs': { name: 'QBreadcrumbs', parent: 'QStyle', children: [], others: [], depedents: [] },
    ...
    'QCard': { name: 'QCard', parent: 'QStyle', children: [], others: [], depedents: [] },
    'QCarousel': { name: 'QCarousel', parent: 'QStyle', children: [], others: [], depedents: [] },
    ...
    'QList': { name: 'QList', parent: 'QStyle', children: [], others: [], depedents: ['QItem'] },
    ...
    'QStepper': { name: 'QStepper', parent: 'QPanels', children: [], others: [], depedents: ['QStep'] },
    'QStyle': { name: 'QStyle', parent: void 0, children: [], others: [], depedents: [] },
    'QTab': { name: 'QTab', parent: 'QStyle', children: [], others: [], depedents: [] },
    'QTable': { name: 'QTable', parent: 'QStyle', children: [], others: [], depedents: [] },
